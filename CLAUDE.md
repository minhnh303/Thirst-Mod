...
Before making any code changes or performing migration tasks, consult the index of known issues in [instructions/index.md](instructions/index.md) to ensure you do not reintroduce or encounter documented issues.
